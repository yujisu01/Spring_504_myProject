...
<body>
<div class="container">
    <form class="form-horizontal" role="form" method="GET" action="${ctx}/secretgarden/member/mypage">
        <div class="row">
    ...
    <!--     <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <button type="button" class="btn btn-primary" onclick="changeForm(0)"> 회원정보 수정</button>
